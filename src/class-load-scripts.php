...
class Load_Scripts{
    ...
    public function hook_my_js($hook)
    {
        ...
        if (is_admin() && $hook == 'developer_page_chipbug-logger') {
            ...
            wp_enqueue_script('chipbug-logger-script', plugins_url('/admin/js/logger.js', dirname(__FILE__)), array('jquery'));
            wp_enqueue_script('chipbug-sse-connect-script', plugins_url('/admin/js/sse_connect.js', dirname(__FILE__)), array('jquery'));
        ...
        if (is_admin() && $hook == 'developer_page_chipbug-logger-options') {
            ...
            wp_enqueue_script('chipbug-options-script', plugins_url('/admin/js/options.js', dirname(__FILE__)), array('jquery'));
            wp_enqueue_script('chipbug-validator-script', plugins_url('/admin/js/form_validator.js', dirname(__FILE__)), array('jquery'));
    ...
    {
        if (is_admin() && $hook == 'developer_page_chipbug-logger') {
            wp_enqueue_style('chipbug-errors-style', plugins_url('/admin/css/logger.css', dirname(__FILE__)));
        }
        if (is_admin() && $hook == 'developer_page_chipbug-logger-options') {
            wp_enqueue_style('chipbug-errors-style', plugins_url('/admin/css/options.css', dirname(__FILE__)));
        }
    }
